...
def find_item_by_name_in_collection(name, collection)	def find_item_by_name_in_collection(name, collection)
...
def consolidate_cart(cart)	def consolidate_cart(cart)
  # Consult README for inputs and outputs	  # Consult README for inputs and outputs
  #	  #
  # REMEMBER: This returns a new Array that represents the cart. Don't merely	  # REMEMBER: This returns a new Array that represents the cart. Don't merely
  # change `cart` (i.e. mutate) it. It's easier to return a new thing.	  # change `cart` (i.e. mutate) it. It's easier to return a new thing.
...
def apply_coupons(cart, coupons)	def apply_coupons(cart, coupons)
  # Consult README for inputs and outputs	  # Consult README for inputs and outputs
  #	  #
  # REMEMBER: This method **should** update cart	  # REMEMBER: This method **should** update cart
  coupons_index = 0
...
@@ -33,4 +97,21 @@ def checkout(cart, coupons)
  #	  #
  # BEFORE it begins the work of calculating the total (or else you might have	  # BEFORE it begins the work of calculating the total (or else you might have
  # some irritated customers	  # some irritated customers
